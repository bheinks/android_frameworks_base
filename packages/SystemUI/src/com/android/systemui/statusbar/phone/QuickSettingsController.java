...
import static com.android.internal.util.cm.QSConstants.TILE_EASYEYEZ;
...
import com.android.systemui.quicksettings.EasyEyezTile;
...
public class QuickSettingsController {
    ...
    void loadTiles() {
        ...
        for (String tile : tiles.split("\\|")) {
            ...
            } else if (tile.equals(TILE_EASYEYEZ)) {
                qs = new EasyEyezTile(mContext, this);
            }
